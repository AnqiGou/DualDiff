...
class ControlNet(nn.Module):
    ...
    def forward(self, x, hint, text_info, timesteps, context, **kwargs):
        ...
        # feature_path = os.path.join(feature_dir, "spatial_glyph_feature.pt")
        # torch.save(enc_glyph, feature_path)
        ...
        # print(guided_hint.shape) # torch.Size([b, 320, 64, 64])

        outs = []

        h = x.type(self.dtype)
        # print('h.shape')
        # print(h.shape) # # torch.Size([b, 4, 64, 64])
        ...
        # print('outs[0].shape')
        # print(outs[0].shape) # torch.Size([b, 320, 64, 64])
        h = self.middle_block(h, emb, context)
        
        # print('h_final.shape')
        # print(h.shape) # torch.Size([b, 1280, 8, 8])
        outs.append(self.middle_block_out(h, emb, context))
        
        # print('outs[0]_final.shape')
        # print(outs[0].shape) # torch.Size([b, 320, 64, 64])
